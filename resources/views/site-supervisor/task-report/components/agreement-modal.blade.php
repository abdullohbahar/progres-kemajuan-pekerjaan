...
<div class="modal fade" tabindex="-1" id="modalSendWeeklyProgress">
    <form action="{{ route('agree.from.site.supervisor') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="siteSupervisorRole" value="{{ $siteSupervisorRole }}">
                </div>
