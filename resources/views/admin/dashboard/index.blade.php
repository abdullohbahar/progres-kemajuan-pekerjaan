                                        ...
                                        <tbody>
                                            @foreach ($activeWorks as $activeWork)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('show.task.report.admin', $activeWork->id) }}"
                                        ...
                                        <tbody>
                                            @foreach ($inactiveWorks as $inactiveWork)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('show.task.report.admin', $inactiveWork->id) }}"
                                                            class="btn btn-info btn-sm">Detail Pekerjaan
                                                        </a></td>
                                                </tr>
                                            @endforeach
                                        ...
                                        <tbody>
                                            @foreach ($spWorks as $spWork)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('show.task.report.admin', $spWork->id) }}"
                                                            class="btn btn-info btn-sm">Detail Pekerjaan
                                                        </a></td>
                                                </tr>
                                            @endforeach
